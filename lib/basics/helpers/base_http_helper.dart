...
import 'package:flutter_samewise/basics/exceptions/http_exception.dart';
...
abstract class BaseHTTPHelper {
  ...
  Future<Map<String, dynamic>> get({String? json, String? endpoint}) async {
    return getGenerics<Map<String, dynamic>>(endpoint: endpoint, json: json);
  }
